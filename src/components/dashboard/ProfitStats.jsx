    ...
    <Card className="bg-white/80 backdrop-blur-sm border border-slate-200 shadow-lg">
      ...
      <CardContent className="pt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <div 
            className="bg-red-50/50 border border-red-100 rounded-lg p-4 cursor-pointer hover:bg-red-50 transition-colors"
            onClick={() => navigateToDetails('penalty')}
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <ChevronRight className="w-3 h-3 text-red-600/50" />
              </div>
            </div>
            <div className="flex justify-between items-end">
              <div>
          ...
          <div 
            className="bg-slate-50/50 border border-slate-200 rounded-lg p-4 cursor-pointer hover:bg-slate-100 transition-colors"
            onClick={() => navigateToDetails('frozen')}
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <ChevronRight className="w-3 h-3 text-slate-600/50" />
              </div>
            </div>
            <div>
